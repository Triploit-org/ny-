...
* Viele Bugfixes
* Es können nun bis zu Tausend Zellen verwendet werden die mit "dmc #[MaximaleZelle]" deklariert weren können ein Beispiel dazu steht in der opennme.ny Datei
